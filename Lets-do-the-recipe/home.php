...
<html lang="en" class="no-js">
	...
	<body>
		<div class="container">
			<!-- <img src="Image_77e5e8b.jpg" id="header-bg" width="100%" height="320px"> -->
			...
			<div id="cbp-pgcontainer" class="cbp-pgcontainer">
				<ul class="cbp-pggrid">
									...
									<div class="cbp-pgcontent">
										<div class="cbp-pgitem">
											<div class="cbp-pgitem-flip">
												<a href="controller/FoodDescController.php?id=<?= $food->id?>"><img src="images/<?= $food->img_url?>"></a>
											</div>
										</div><!-- /cbp-pgitem -->
					...
					<!-- <li>
						...
						<div class="cbp-pginfo">
							<h3>Shrimps</h3>
							<span class="cbp-pgprice">Rp 400.000</span>
						</div>
					</li>
					<li>
						<div class="cbp-pgcontent">
						...
						<div class="cbp-pginfo">
							<h3>Satay</h3>
							<span class="cbp-pgprice">Rp 100.000</span>
						</div>
					</li> -->
